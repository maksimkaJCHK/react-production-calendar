...
Я старался использовать максимально возможную поддержку, и он будет работать даже в 11 IE хотя это не всегда нужно.